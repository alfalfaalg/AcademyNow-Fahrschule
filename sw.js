...
const CACHE_NAME = 'academynow-fahrschule-v1.0.4-black-theme';
const STATIC_CACHE = 'academynow-static-v4-black-theme';
const DYNAMIC_CACHE = 'academynow-dynamic-v4-black-theme';
